...
from models import CNNMnist, CNNCifar, DNNCivil
...
if __name__ == '__main__':
    ...
    if args.dataset == 'mnist':
        ...
        global_model = DNNCivil(args)  #.cuda()
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        pred, test_acc, test_loss = inference(global_model, test_loader)
